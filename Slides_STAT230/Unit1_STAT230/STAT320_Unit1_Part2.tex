...
\begin{frame}
\qBrd[4.5in]{babyblue!50}{
Let $\HLTW{\lambda >0}$,  then   $$ \HLTY{\displaystyle \sum_{j=1}^{\infty} \frac{ \lambda^j}{(j-1)!}}= \HLTW{\displaystyle1+   \frac{\lambda}{0!}+   \frac{\lambda^2}{1!} +  \frac{\lambda^3}{2!} +\cdots}   =?.$$ 
}
\vspace{2in}
\end{frame}
...
$\HLTW{\displaystyle  \HLTY{\displaystyle \sum_{k=1}^{n} e^{kt}{n \choose k }x^k}= } $
}
\vspace{2.5in}
\end{frame}
