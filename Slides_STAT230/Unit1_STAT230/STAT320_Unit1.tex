...
\begin{enumerate}
\item[] \qBrd[2.5in]{blush!40}{$\HLTW{[a,b]}:=\{x\in \R : a\leq x\leq b \}$}
\item[] \qBrd[2.5in]{applegreen!40}{$\HLTW{(a,b]}:=\{x\in \R : a< x\leq b \}$}
\item[] \qBrd[2.5in]{brightpink!35}{$\HLTW{[a,b)}:=\{x\in \R : a\leq  x< b \}$}
\item[] \qBrd[2.5in]{babyblue!50}{ $\HLTW{(a,b)}:=\{x\in \R : a< x<b \}$}
\end{enumerate}
\end{center}
}
\vspace{3in}
...
\begin{frame}\frametitle{A Discussion on Cardinality of Sets, Reals and Integers}
