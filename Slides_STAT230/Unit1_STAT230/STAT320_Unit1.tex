...
\qBrd[4.5in]{tangerine!40}{\sqBullet{orange}$\HLTW{\infty}$ is not a real number.  It is a concept to denote the suprimum in the real number system. We may think it to be larger than any given/prespecified number.  }
 \end{frame}
