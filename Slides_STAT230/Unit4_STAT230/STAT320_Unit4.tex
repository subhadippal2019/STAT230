...
$$\HLTW{\displaystyle P(E\mid F):= \frac{P(E\cap F)}{P(F)}.}$$
}
\end{frame}
...
\begin{frame}{Example}
\qbx[4.6 in]{teal!30}{\Qn: If two events, A and B, are such that $P( A)=0.5$, $P(B)=0.3$, and $P( A\cap B)= 0.1$, find the following
\begin{enumerate}
\item $P(A\mid B)$
\item $P(B\mid A)$
