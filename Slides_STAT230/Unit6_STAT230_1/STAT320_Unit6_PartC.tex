...
\qBrd[1.9in]{applegreen!40}{ $\Large \displaystyle \int e^{-x^2} dx$}\qBrd[1.9in]{rose!30}{$\displaystyle  \int  \frac{\sin(x)}{x}dx  $.}
\end{center}
\vspace{-.2in}
...
%\begin{frame}
%$\Row{\Col{
%{\qBrd[1.5in]{applegreen!50}{
%\Large $\Phi\left(\HLTEQ[rose!30]{1.96}\right)=\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} $ 
%}},{\qBrd[1.5in]{babyblue!50}{
%\Large $\Phi\left(\HLTEQ[orange!30]{0.80}\right)=\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} $ 
%}}, {\qBrd[1.5in]{blue!30}{
%\Large $\Phi\left(\HLTEQ[lime!30]{1.23}\right)=\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} $ 
%}}  \vspace{2.2in}},{
%\includegraphics[scale=.25]{figs/NormalTable1.png}}
%}$
%
%\end{frame}
%
...
%$\Row{\Col{
%{\qBrd[1.5in]{applegreen!50}{
%\Large $\Phi\left(\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}}\right)=\HLTEQ[rose!30]{0.57} $ 
%}},{\qBrd[1.5in]{babyblue!50}{
%\Large $\Phi\left(\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} \right)=\HLTEQ[orange!30]{0.90}$ 
%}}, {\qBrd[1.5in]{blue!30}{
%\Large $\Phi\left(\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}}\right)=\HLTEQ[lime!30]{0.95} $ 
%}}  \vspace{2.2in}},{
%\includegraphics[scale=.25]{figs/NormalTable1.png}}
%}$
%
...
\TransitionFrame[amber]{\Large Standard Normal Distribution}
...
\includegraphics[scale=.3]{figs/StandardNormal1.png}

\qBrd{babyblue!40}{ \sqBullet{babyblue}The Standard Normal pdf s denoted as:  \qBrd[.5in]{amber!50}{\Large$\phi(x)$}  }
\vspace{.05in}

\qBrd{amethyst!50}{  \sqBullet{amethyst} The Standard Normal CDF is denoted as: \qBrd[.5in]{amber!50}{\Large$\Phi(x)$}  
}
\end{frame}

\begin{frame}
$\Row{{\includegraphics[scale=.2]{figs/NormalTableDiagram2.png}},{\hspace{.7in}},{\includegraphics[scale=.2]{figs/NormalTableDiagram1.png}}}$
$\Row{{
\includegraphics[scale=.29]{figs/NormalTable2.png}},{\hspace{.1in}},{
\includegraphics[scale=.29]{figs/NormalTable1_entire.png}}}$
\end{frame}


\begin{frame}
$\Row{\Col{{\qBrd[1.5in]{babyblue!50}{
\Large $\Phi\left(\HLTEQ[orange!30]{0.80}\right)=\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} $ \vspace{.3in}
}} , 
 {\qBrd[1.5in]{blue!30}{
\Large $\Phi\left(\HLTEQ[lime!30]{1.23}\right)=\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} $ \vspace{.3in}
}},
{\qBrd[1.5in]{applegreen!50}{
\Large $\Phi\left(\HLTEQ[rose!30]{1.96}\right)=\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} $ \vspace{.3in}
}} \vspace{2.2in}},{
\includegraphics[scale=.25]{figs/NormalTable1.png}}
}$
...
%{\qBrd[1.42in]{babyblue!50}{
%\Large $\Phi\left(\HLTY{  \Huge  \color{yellow}{?}\hspace{.1in}} \right)=\HLTEQ[orange!30]{0.90}$  \hspace{-.2in}
%}},
{\qBrd[2in]{blue!30}{
...
\TransitionFrame[antiquefuchsia]{\Large Connection between a {\bf Normal($\mu, \sigma^2$),} and {\bf Standard Normal} Distribution}
...
\vspace{.1in}
\qBrd{amber!40}{
\qBrd[1.6in]{amber!70}{\Large Z-Transformation } 
...
\vspace{-.25in}
\begin{center}
\qBrd[3.5in]{teal!40}{  Let $ X\sim \text{Normal}(\mu, \sigma^2)$,  How to find $\HLTEQ[lime]{p}$ such that  $\HLTW{P(X\leq \HLTY{x})=\HLTEQ[lime]{p}}$ }
\vspace{.1in}\\
\qBrd[3.5in]{rose!40}{
\begin{eqnarray}
\HLTEQ[lime]{p}= \HLTW{P\left(X\leq \HLTY{x}\right)}
& =& P\left( X-\mu \leq  \HLTY{x}- \mu \right) \nonumber\\
& =& P\left( \frac{X-\mu}{\sigma} \leq \frac{ \HLTY{x}- \mu}{\sigma} \right) \nonumber\\
& =& P\left(\HLTW{Z} \leq \frac{ \HLTY{x}- \mu}{\sigma} \right) \nonumber\\
& =&\HLTW{ \Phi\left( \frac{ \HLTY{x}- \mu}{\sigma} \right)} \nonumber
\end{eqnarray}
}
\end{center}
}
$$\DBX{ \Large \HLTEQ[lime]{p}=  \HLTW{ \Phi\left( \frac{ \HLTY{x}- \mu}{\sigma} \right)  }  }$$
\vspace{-.1in}
\end{frame}
...
\begin{frame}
\qBrd[4.5in]{antiquefuchsia!70}{
\vspace{-.2in}
\begin{center}
\qBrd[3.5in]{olive!60}{   $ X\sim \text{Normal}(\mu, \sigma^2)$,  \\How to find $\HLTY{x=?}$ such that  $\HLTW{P(X\leq \HLTY{x})=\HLTEQ[lime]{p}}$ }
\vspace{.1in}\\
\qBrd[3.5in]{applegreen!20}{
\begin{eqnarray}
\HLTEQ[lime]{p}
& =&\HLTW{ \Phi\left( \frac{ \HLTY{x}- \mu}{\sigma} \right)}\nonumber\\
\implies \HLTW{ \Phi^{-1}\left(\HLTEQ[lime]{p} \right)} & =&   \frac{ \HLTY{x}- \mu}{\sigma}  \nonumber\\
\implies \mu+\sigma \times \HLTW{ \Phi^{-1}\left(\HLTEQ[lime]{p} \right)} & =&  \HLTY{x}  \nonumber
\end{eqnarray}
}
\end{center}
}
$$\DBX{ \Large   \HLTY{x}=  \mu+\sigma \times \HLTW{ \Phi^{-1}\left(\HLTEQ[lime]{p} \right)}  }$$
\vspace{-.1in}
\end{frame}
...
\begin{frame}
\includegraphics[scale=.38]{figs/GenNorm_2}
\vspace{1.5in}
\end{frame}

\begin{frame}
\includegraphics[scale=.38]{figs/GenNormInv}
\vspace{1.5in}
\end{frame}
...
\TransitionFrame[antiquefuchsia]{\Large Various Examples}
