...
\begin{frame}
\define{Support of a Continuous Random Variable}{
Let $X$ be a continuous random varibale with probability density function $f_{_X}(x)$. The support of the random variable is defined to be 
$$\HLTW{\Large \displaystyle \support[X]=\{x : f_{_X}(x)>0\}}$$
}
\vspace{.1in}
\qBrd[4.5in]{amethyst!40}{
\sqBullet{amethyst} Support of a random variable refers to the all possible value or outcome of the random variable.  Technically,  if a point is a  possible outcome, the corresponding value of the pdf is positive.  
}
\vspace{1in}
\end{frame}


\begin{frame}{Relation between pdf and CDF of a continuous random variable}
\qBrd[4.2in]{babyblue!30}{
...
\qBrd[4.2in]{applegreen!30}{   {\bf CDF} of a continuous random variable can be obtained by integrating the corresponding {\bf pdf} 
$$\HLTW{ \displaystyle F_{_X}(\HLTY{x})= \int\limits_{-\infty}^{\HLTY{x}} f_{_X}(y) dy }$$}\\


\end{frame}

\begin{frame}{Probability Density Function (pdf):  For  continuous  RV}
...
$\HLTW{\Large \displaystyle f_{_X}(x)= \frac{d}{dx} F_{_X}(x)}.$
 }\\
 \vspace{.2in}
\qBox{
...
\define{Characterization of  Probability Density Function (pdf)}{
...
\vspace{.1in}
\qBrd[4.5in]{amethyst!40}{Support of a Continuous Random Variable
Let $X$ be a continuous random varibale with probability density function $f(x)$. The support of the random variable is defined to be 
$$\HLTW{\Large \displaystyle \support[X]=\{x : f_{_X}(x)>0\}}$$
}
\end{frame}
...
{\tiny 
 ...
 \begin{eqnarray}
& &  \int\limits_{\support[X]} f(x)dx=1\nonumber\\
