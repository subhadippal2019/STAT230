...
Let $\binP\in (0,1)$, then the probability mass function of $\text{Binomial}(n, \binP)$ is given by
$$\HLTEQ[amethyst!50]{ \HLTW{\displaystyle \HLTY{\pmf(x)}:= {n \choose x} \binP^x (1-\binP)^{n-x}}}, \text{ for } x \in \support[X],  \text{where } \HLTEQ[teal!30]{ \support[X]=\{ 0, 1, \ldots,  n\}}$$\\
}
\vspace{.1in}
...
\HLTW{E(X)= n \binP} },  \qBrd[1.5in]{amethyst!50}{\text{Variance}\\\HLTW{\text{VAR}(X)= n \binP (1-\binP)}}  , \qBrd[1.7in]{amethyst!50}{\text{MGF}\\\HLTW{\text{M}_{_X}(t)=\left( 1-\binP+pe^t\right)^n   }} } $
%}
...
& $\support[X]$  &   $\pmf_{_X}(x)$   &  $E(X)$  &   $\text{Var}(X)$  &  $M_{_X}(t)$  \\
 \hline \hline
 & & & & & \\
Binomial$(n, \binP)$ &$ \{0, 1, \ldots, n\}$ & ${n \choose x} \binP^x (1-\binP)^{n-x}  $ & $n\binP$  & $n\binP(1-\binP)$&   $\left( 1-\binP+pe^t\right)^n$   \\
 & & & & & \\
 \hline
  \hline
\end{tabular}
...
The requirements for a Poisson distribution are that:
\begin{enumerate}
\item The probability mass function of $\text{Poisson}(\lambda)$ is given by $$ \qBrd[2in]{amethyst!30}{$p(x) = \frac{e^{-\lambda}\lambda^x}{x!}$} \text{ for } x = 0, 1, 2, 3, \ldots $$
...
The probability mass function of $Geometric(\binP)$ is given by
$$p(x) = (1-\binP)^{x-1}\binP \text{ for } x = 1, 2, 3, \ldots, $$
}
...
& $\support[X]$  &   $\pmf_{_X}(x)$   &  $E(X)$  &   $\text{Var}(X)$  &  $M_{_X}(t)$  \\
 \hline \hline
 & & & & & \\
Geometric$( \binP)$ &$ \{1, 2, \ldots \}$ & $ (1-\binP)^{x-1}\binP  $ & $ \frac{1}{\binP} $  & $ \frac{1-\binP}{\binP} $&   $ \frac{ \frac{1}{\binP} e^t}{1-(1-\binP) e^{t}}    $   \\
 & & & & & \\
 \hline
  \hline
\end{tabular}
...
The probability mass function of Negative Binomial RV, denoted by $\text{Negative-Binomial}(r, \binP)$ is given by
$$p(x) ={{x-1}\choose{r-1}}\binP^{r-1} (1-\binP)^{x-r} \text{ for } x = r+1, r+2,r+ 3, \ldots, $$
}
...
\HLTW{E(X)= \frac{r}{\binP} } },  \qBrd[1.5in]{carrotorange!50}{\text{Variance}\\\HLTW{\text{VAR}(X)=   \frac{r(1- \binP)}{\binP}}}  , \qBrd[1.7in]{carrotorange!50}{\text{MGF}\\\HLTW{\text{M}_{_X}(t)=\left( \frac{\binP e^t}{1-(1-\binP)e^{t}}\right)^r    } } } $
%}
...
& $\support[X]$  &   $\pmf_{_X}(x)$   &  $E(X)$  &   $\text{Var}(X)$  &  $M_{_X}(t)$  \\
 \hline \hline
 & & & & & \\
Negative-Binomial$(r,  \binP)$ &$ \{r+1, r+2, \ldots \}$ & $ {{x-1}\choose{r-1}}(1-\binP)^{x-r}\binP^{r-1}  $ & $ \frac{r}{\binP} $  & $ \frac{r(1-\binP)}{\binP} $&   $\left( \frac{  \binP e^t}{1-(1-\binP) e^{t}}  \right)^r  $   \\
 & & & & & \\
 \hline
  \hline
\end{tabular}
