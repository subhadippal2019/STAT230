...
\NewDocumentCommand{\MCQchk}{O{1.75 in}O{amethyst!50}m}{
\qBrd[#1]{#2}{\TextInBoxTwo[white]{.1 in}{$\checkmark$}\;\;\HLTW{\text{#3}	}}
} 
 
 
 

\NewDocumentCommand{\MCQ}{O{1.75 in}O{amethyst!50}m}{
\qBrd[#1]{#2}{\TextInBoxTwo[white]{.1 in}{ \color{white}\checkmark}\;\;\HLTW{\text{#3}	}}
}  
