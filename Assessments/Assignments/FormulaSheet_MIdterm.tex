...
\begin{center}
\vspace{-.2in}
\qBrd[2.6in]{amber!70}{\Large Bayes' Theorem }\\
\end{center}
\vspace{-.15in}
...
\qBrd[6.5in]{apricot!50}{
\vspace{-.35in}
\begin{center}
\qBrd[4.9in]{apricot!80}{ \begin{center}\Large {\bf \Large ``Moment Generating Function (MGF) ''} of a Discrete Random Variable \end{center} }
\end{center}
