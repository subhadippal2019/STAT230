...
$$\HLTW{ \displaystyle P(B\mid A)=\HLTY{ \frac{ \displaystyle \HLTEQ[green!30]{P(A\mid B) P(B )}}{\displaystyle \HLTEQ[green!30]{P(A\mid B) P(B )}+ \HLTEQ[orange!30]{P(A\mid \Not{B}) P(\Not{B} ) }     }}}$$
}\\
\vspace{.1in}
