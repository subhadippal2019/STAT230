...
\item  \QuizQuestion{ \TextInBoxOne{5.4in}{
According to the World DataBank the {\bf Crude Birth Rate (CBR)} and the {\bf Crude Death Rate} for the entire world in the year 2020 is given as 16.7 (per 1000 population) and 8.9 (per 1000 population). Then what is the  world  population growth rate (in percentages) {\bf AGR}\% in the year 2020?
}}{
Ans:\MCOption[1.1in]{$78.00\%$}\MCOption[1.1in]{$7.80\%$} \MCOption[1.1in]{$0.78\%$}\MCOption[1.1in]{$0.078\%$}
}{Total Score: 5}\\

\item  \QuizQuestion{ \TextInBoxOne{5.4in}{
Consider the Lorenz curves of wealth inequality for Brazil, Japan, Sweden, USA.  Based on the plot below,  which country has {\bf  lowest } wealth inequality among the four?
\begin{center}
...
\item  \QuizQuestion{ \TextInBoxOne{5.4in}{
Consider the histogram of  the variable `Infant Mortality Rate'   for a few countries. 
\begin{center}
...
Assuming that the AAGR\% for UAE's population remain fixed at  $1.041$, {\bf calculate the {\it \bf Doubling Time (DT)} of the UAE's population. }
}}{\vspace{.1in}
...
$$\HLTEQ[gray!20]{\Row{43.1{,},	51.2{,},	55.2{,},	62.3{,},	73.1{,},	75.0{,},	82.8}}$$
...
\item  \TextInBoxTwo[lightBlueTwo]{6.25in}{  \TextInBoxOne{6in}{To estimate the `average life expectancy' in {\bf less-developed countries}, a random sample of 144 less-developed countries were considered.  The corresponding data summary is obtained as
...
\begin{enumerate}
\item \ExamQuestion{ \TextInBoxOne{5.7in}{	Compute the 99\% confidence interval for the `average life expectancy' in less-developed countries.
}}{ \\
}{\hspace{-.2in}Total Score: 5 }\\
\vspace{3in}
...
Income share held by third 20\%   & 15                            \\ \hline
Income share held by fourth 20\%  & 30        \\ \hline
Income share held by highest 20\% & 40        \\ \hline
\end{tabular}
}}
\begin{enumerate}
...
\item[5.] \TextInBoxTwo[lightBlueTwo]{6.25in}{ 
 ...
 \begin{center}
 \includegraphics[scale=.4]{LineSchoolHDI.png}
 \end{center}
...
\vspace{2in}
\item \ExamQuestion{ \TextInBoxOne{5.7in}{Compute the value of the {\bf intercept}  and  provide its {\bf interpretation}.  Is the interpretation meaningful in the  context of the current example?
}}{ 
